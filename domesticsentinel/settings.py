"""
Django settings for Home Project and Vendor Management project.
...
SECRET_KEY = env("SECRET_KEY", default="django-insecure-OJ4tWKuVWIBAOyQwb28GBEcYwyiaIDeOSsOgjpaE")
...
ROOT_URLCONF = "domesticsentinel.urls"
...
WSGI_APPLICATION = "domesticsentinel.wsgi.application"
...
if "DATABASE_URL" in env:
    ...
    DATABASES = {
        "default": {
            ...
            "NAME": env("DJANGO_DATABASE_NAME", default="domesticsentinel"),
...
LANGUAGE_CODE = "en-us"
LANGUAGE_COOKIE_NAME = "domesticsentinel_language"
LANGUAGES = [
...
DEFAULT_FROM_EMAIL = env("DEFAULT_FROM_EMAIL", default="shayne@fennon.com")
...
EMAIL_SUBJECT_PREFIX = "[Home Project and Vendor Management] "
...
SPECTACULAR_SETTINGS = {
    "TITLE": "Home Project and Vendor Management",
    "DESCRIPTION": "Vendor account, contact and product tracking with project management and scheduling",
    "VERSION": "0.1.0",
...
PROJECT_METADATA = {
    "NAME": gettext_lazy("Home Project and Vendor Management"),
    "URL": "http://localhost:8000",
    "DESCRIPTION": gettext_lazy("Vendor account, contact and product tracking with project management and scheduling"),
    "IMAGE": "https://upload.wikimedia.org/wikipedia/commons/2/20/PEO-pegasus_black.svg",
    "KEYWORDS": "SaaS, django",
    "CONTACT_EMAIL": "shayne@fennon.com",
}

# set this to True in production to have URLs generated with https instead of http
USE_HTTPS_IN_ABSOLUTE_URLS = env.bool("USE_HTTPS_IN_ABSOLUTE_URLS", default=False)

ADMINS = [("Shayne Sivley", "shayne@fennon.com")]
...
LOGGING = {
    ...
    "loggers": {
        ...
        "domesticsentinel": {
            "handlers": ["console"],
            "level": env("DOMESTICSENTINEL_LOG_LEVEL", default="INFO"),
        },
    },
}
